  ...
  return (
    <div className="banner-section" id="intro">
      <div className="main-slider-carousel owl-carousel owl-theme">
        ...
        >
          <Image className="!object-cover" src={"/images/main-slider/intro-2.webp"} alt="background image" priority={true}  fill  quality={65}/>
            ...
            <div className="row clearfix">
              <div className="content-column col-lg-7 col-md-12 col-sm-12">
                <div className="inner-column">
                  ...
                  Ambitious Omani Oilfield Service Company
                    {/* Global <span>Aspirations</span>,<br />
                    Local <span>Inspirations</span>    sadf */} 
                  </h1>
                  <div className="text text-white ">
                  XOM prides itself with putting Safety and Quality first. <br /> We serve our clients respecting their values and understanding their needs.
        ...
        >
                   <Image className="!object-cover"  src={"/images/main-slider/intro-3.webp"} loading="lazy"  alt="background image" fill={true} quality={65}/>
            ...
            <div className="row clearfix">
              <div className="content-column col-lg-7 col-md-12 col-sm-12">
                <div className="inner-column">
                  <div className="title text-white">XOM Oilfield Services</div>
                  <h1 className="text-5xl text-white font-extrabold">
                  Engineering Oilfield <br />Solutions 
                    {/* Global <span>Aspirations</span>,<br />
