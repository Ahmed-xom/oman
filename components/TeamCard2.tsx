...
import { managementTeam, TeamMember } from "@/app/our-leaders/CardsData2";
...
function TeamCard2() {
 ...
 <>
      {managementTeam.map((member: TeamMember, index:number) => (
        <div key={index} 
        role="listitem"
        className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-20 md:mb-32 sm:mb-24 xl:max-w-80 lg:w-2/5 shadow-md bg-white border-b-8 border-[#fb8f44]"
      id="card-head">
